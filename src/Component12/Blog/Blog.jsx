...
import blogImage from "/images/charity-classic-blog-img.png";
import blogImage2 from "/images/charity-classic-blog-img2.png";
import blogImage3 from "/images/charity-classic-blog-img3.png";
...
const Blog = () => {
  ...
  return (
    <div className="relative z-10 -mt-5 -mb-5">
      <section className="bg-SecondaryColor-0 py-16 md:py-20 lg:py-[120px] overflow-hidden">
        <div className="Container mb-5">
          ...
          <div className="box-row mt-10 md:mt-[58px] 2xl:px-5 3xl:px-0">
            <Swiper {...settings}>
              {blogPosts.map((post) => (
