...
const Testimonial = () => {
  ...
  return (
    <section className="bg-[url(/images/charity-classic-testi-bg.png)] bg-cover bg-no-repeat bg-center relative z-30 pt-16 md:pt-20 lg:pt-[120px] pb-36 md:pb-52 lg:pb-[310px] -mt-6">
