  ...
  return (
    <div className="group text-center relative z-10">
      ...
      <div className="relative z-10 text-center inline-block">
        <div className="size-[130px] mx-auto rounded-full flex items-center justify-center shrink-0 bg-white bg-opacity-10 relative z-10 overflow-hidden before:absolute before:left-0 before:top-0 before:size-full before:bg-PrimaryColor-0 before:rotate-180 before:transition-all before:duration-500 before:scale-0 before:-z-10 group-hover:before:scale-100 group-hover:before:rotate-0">
          <img
            src={processIcon}
            alt="Process Icon"
            draggable={false}
