...
const Testimonial = () => {
  ...
  return (
    <section className="bg-[url(/images/charity-classic-testi-bg.png)] bg-cover bg-no-repeat bg-center relative z-30 pt-20 md:pt-24 lg:pt-[160px] pb-36 md:pb-52 lg:pb-[310px] -mt-6">
