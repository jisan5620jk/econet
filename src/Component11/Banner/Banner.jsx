      ...
      <Swiper {...swiperSettings}>
        {slides.map((slide, index) => (
          <SwiperSlide key={index}>
            <div className="bg-[url(/images/charity-classic-banner-bg.png)] bg-cover bg-no-repeat bg-center 2xl:px-5 3xl:px-0 pt-24 sm:pt-20 md:pt-40 2xl:pt-[120px] rounded-xl sm:rounded-2xl md:rounded-[30px] relative z-10 overflow-hidden">
              <div className="Container">
                <div className="lg:pb-44 xl:pb-[124px]">
                  {/* Subtitle */}
                  <h6
                  ...
                  {/* Bottom Info */}
                  <div
                    className={`mt-20 md:mt-[120px] pt-6 flex items-center gap-4 max-w-[646px] w-full border-t border-white border-opacity-20 transition-all duration-700 ${
                      activeIndex === index
