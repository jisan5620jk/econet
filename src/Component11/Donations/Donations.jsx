...
const Donations = () => {
  return (
    <div className="bg-white -mt-5 relative z-30">
      <section className="bg-[url(/images/charity-classic-donation-bg.png)] bg-cover bg-no-repeat bg-center py-16 md:py-20 lg:py-[120px]">
