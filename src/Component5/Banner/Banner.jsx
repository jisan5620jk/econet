        ...
        <div className="Container">
          <div className="grid lg:grid-cols-2 items-center gap-16 lg:gap-0">
            <div className="relative">
              <h5 className="font-NotoSans bg-white bg-opacity-30 pl-2 sm:pl-4 pr-5 py-[7px] rounded-r-full border border-white text-HeadingColor-0 text-sm inline-flex items-center gap-2 uppercase mb-4 md:mb-2">
              ...
              <h1 className="font-Outfit font-semibold text-HeadingColor-0 text-3xl sm:text-[50px] sm:leading-[60px] md:text-[60px] md:leading-[70px] lg:text-[42px] lg:leading-[48px] xl:text-[58px] xl:leading-[68px] 2xl:text-[65px] 2xl:leading-[75px]">
                <span className="flex gap-3 items-center md:-mb-2">
                  ...
                  <div className="flex items-center gap-1">
                    <span className="text-PrimaryColor-0">
                      <OnScrollCounter start={0} end={2319} duration={2000} />
                    </span>
                ...
                <div className="flex gap-2 sm:gap-5 flex-col sm:flex-row sm:items-center">
                  ...
                  <div>
                    <div className="!font-Outfit text-PrimaryColor-0 flex gap-1 items-center uppercase">
                      <OnScrollCounter start={0} end={15} duration={1000} />
            ...
            <div className="sm:flex justify-center lg:justify-end relative">
              ...
              />
              <div className="absolute top-0 left-0 md:left-[14.4%] lg:left-[0.4%] xl:left-[10%] 2xl:left-[23.3%] rounded-2xl md:rounded-[20px] overflow-hidden bg-PrimaryColor-0 h-20 sm:h-[138px] lg:h-[130px] xl:h-[138px] w-[34%] md:w-[23.5%] lg:w-[33%] xl:w-[30%] 2xl:w-[25.7%] pt-1 sm:pt-8 pl-2 sm:pl-5">
                <img
                  src={author}
                  draggable={false}
                  alt="User"
