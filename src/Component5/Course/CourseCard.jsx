...
const CourseCard = ({
  ...
  return (
    <div
      className={`group rounded-xl overflow-hidden ${bgColor} p-4 lg:p-2 2xl:p-4`}
    >
      ...
      <div className="sm:px-3 lg:px-0 2xl:px-3">
        ...
        <div className="flex items-center flex-wrap gap-y-3 gap-x-8 font-NotoSans text-gray-500 mt-7 mb-4">
