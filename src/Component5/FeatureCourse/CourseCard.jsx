    ...
    >
      ...
      <div className="flex-1">
        <div className="flex justify-between items-center mb-6">
          <span
            className={`font-NotoSans text-[15px] px-5 py-[5px] rounded-3xl inline-block uppercase border ${categoryColor}`}
          >
            {category}
          </span>
        ...
        <div className="flex items-center gap-8 font-NotoSans border-t border-HeadingColor-0 border-opacity-20 pt-5 mt-4 mb-7">
          <div className="flex items-center gap-2 font-NotoSans text-TextColor-0">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center xl:flex-col xl:items-start 2xl:flex-row 2xl:items-center gap-2 text-sm text-gray-800">
          ...
          <span
            className={`flex items-center ${textColor} sm:ml-3 xl:ml-0 2xl:ml-3`}
          >
            {[...Array(5)].map((_, i) => (
