    ...
    <section className="bg-white py-16 md:py-20 lg:py-28">
      <div className="Container">
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          <div className="">
            <h5 className="font-NotoSans bg-PrimaryColor-0 bg-opacity-20 pl-4 pr-5 py-[7px] rounded-r-full border border-PrimaryColor-0 border-opacity-20 text-HeadingColor-0 text-sm inline-flex items-center gap-2 uppercase">
            ...
            <p className="font-NotoSans text-TextColor-0 text-[17px] w-full max-w-[525px] mb-9">
