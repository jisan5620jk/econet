...
const ServiceNavigation = ({ swiperRef }) => {
  return (
    <div className="flex justify-center">
      <div className="flex justify-center md:justify-end items-center gap-3 absolute left-0 md:left-auto  md:right-0 top-10 md:-top-[100px] max-w-[1320px] w-full mx-auto">
        <button
