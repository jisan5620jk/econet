          ...
          <div className="flex flex-col md:flex-row justify-between mt-[58px]">
            ...
            <div className="flex-1 flex flex-col space-y-4 mr-9 mt-[38px]">
              {featuresLeft.map((item, index) => (
                <div
                  key={index}
                  className="group flex gap-4 items-center justify-start bg-white p-5 rounded-full transition shadow-shade max-w-[395px] w-full relative z-10 overflow-hidden"
                >
                  <div
