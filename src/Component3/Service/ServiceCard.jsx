  ...
  return (
    <div className="group rounded-[20px] relative z-10 overflow-hidden">
      ...
      <div className=" -mt-[94px]">
        ...
        <div className="ml-auto w-[calc(100%-20px)] sm:w-[calc(100%-40px)] bg-white relative z-10 rounded-[20px] pl-[34px] pt-9 pb-8 overflow-hidden before:absolute before:top-0 before:right-0 before:w-0 before:h-full before:bg-BodyBgDark-0 before:-z-10 before:transition-all before:duration-500 group-hover:before:left-0 group-hover:before:w-full">
          <Link
            to={serviceUrl}
