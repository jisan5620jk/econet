...
const FeatureCard = ({
  ...
  return (
    <div className="group rounded-[20px] px-6 sm:px-11 pt-6 sm:pt-[52px] pb-6 sm:pb-[46px] relative z-10 overflow-hidden bg-BodyBg-0">
      <div>
        {[
