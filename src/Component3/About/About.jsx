            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-5 mt-8 mb-9">
              <div className="bg-PrimaryColor-0 bg-opacity-[7%] h-[316px] flex flex-col justify-between rounded-[20px] px-7 lg:px-4 xl:px-7 pt-8 pb-9">
                <div>
                  ...
                  <p className="font-NotoSans lg:text-sm xl:text-base text-TextColor-0 max-w-[570px] w-full pt-[6px]">
              ...
              <div className="bg-PrimaryColor-0 bg-opacity-[7%] h-[316px] flex flex-col justify-between rounded-[20px] px-7 pt-8 pb-9">
                <div className="">
                  <div className="text-5xl md:text-[56px] lg:text-[56px] leading-[56px] tracking-wide font-semibold font-Outfit text-PrimaryColor-0 inline-flex items-center relative">
                  ...
                  <div>
                    <p className="font-NotoSans lg:text-sm text-TextColor-0 mt-2">
