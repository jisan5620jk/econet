...
const BlogRightSideBar = () => {
  return (
    <>
      <HelmetChanger title={"Blog List Right Sidebar Inner Page"} />
      <BreadCrumb2
        breadCrumbTitle={"Blog List Right Sidebar"}
        url={"/blog"}
              ...
              <div className="bg-white shadow-shades border-t-[6px] border-PrimaryColor-0 rounded-b-md px-4 sm:px-8 lg:px-6 xl:px-10 pt-9 pb-4 mb-7">
                <div className="relative inline-block w-full">
                  <input
                    ...
                    required
                    className="w-full h-[56px] p-6 bg-BodyBg-0 rounded font-NotoSans"
                  />
                  <button
                    type="submit"
                  ...
                  <Link to={"/blog_details"}>
                    <button className="group flex gap-5 mb-6">
                      ...
                      <div className="flex-1 text-left">
                        ...
                        <p className="font-NotoSans text-TextColor2-0 text-sm mt-1">
                          01 Jan, 2025
                        </p>
                      </div>
                    </button>
                ...
                <div className="pt-12 pb-2">
                  ...
                  <ul className="inline-block">
                    <li className="inline-block mr-[10px] mb-[10px]">
                      <Link to={"/"}>
                        <button className="bg-white flex items-center border border-SecondaryColor-0 border-opacity-10 rounded-full justify-center font-NotoSans text-sm overflow-hidden text-TextColor-0 transition-all duration-500 px-5 py-2 relative z-10 before:absolute before:top-0 before:right-0 before:rounded before:w-0 before:h-full before:bg-PrimaryColor-0 before:transition-all before:duration-500 before:-z-10 hover:before:w-full hover:before:left-0 hover:text-white">
                          Cyber Security
                        </button>
                      </Link>
                    </li>
