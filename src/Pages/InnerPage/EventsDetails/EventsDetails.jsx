      ...
      <div className="Container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="font-NotoSans text-TextColor-0 max-w-[785px] w-full">
            ...
            <p className="font-NotoSans text-TextColor-0 mt-6 mb-[52px] max-w-[810px] w-full">
            ...
            <div className="space-y-3 mt-6 mb-7">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center gap-2 font-NotoSans text-TextColor-0"
                >
