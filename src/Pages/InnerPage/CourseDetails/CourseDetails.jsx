        ...
        <div className="Container">
          <div className="grid grid-cols-3 gap-7">
            <div className="col-span-3 lg:col-span-2 mt-16 md:mt-20 lg:mt-28">
              ...
              <p className="font-NotoSans text-TextColor2-0 mt-6">
              ...
              <p className="font-NotoSans text-TextColor2-0 mt-7 mb-9">
              ...
              <ul>
                <li className="flex items-center gap-2 font-NotoSans text-TextColor-0">
                            ...
                            {items.map(({ title: itemTitle, duration }) => (
                              ...
                              >
                                <div className="flex items-center space-x-3">
                                  <button
                                    className={`flex items-center justify-center text-2xl text-PrimaryColor-0 hover:text-PrimaryColor-0 transition-all duration-500`}
              ...
              <div className="flex items-center gap-5 w-full h-[224px] mt-10">
                ...
                <div className="w-full space-y-4 h-full bg-PrimaryColor-0 bg-opacity-[7%] rounded-2xl flex flex-col items-center justify-center">
              ...
              <div className="bg-white mt-10">
                ...
                <div className="mb-6 border-b border-HeadingColor-0 border-opacity-10 pb-8">
                  <div className="flex items-center gap-5 mb-6">
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {/* Time Ago */}
                        <p className="font-NotoSans text-HeadingColor-0 text-sm mt-1">
                          16 min ago
                        </p>
                      </div>
                    </div>
                  ...
                  {/* Review Text */}
                  <p className="font-NotoSans text-TextColor-0 max-w-[725px] w-full">
                    Educate the ultimate destination for knowledge seekers and
