    ...
    >
      <div className="flex items-center gap-5">
        ...
        <div>
          ...
          <p className="font-NotoSans text-TextColor-0 pt-[2px]">
            {targetUser}
          </p>
        </div>
      </div>
      ...
      <ul className="space-y-3 mb-2.5 mt-9">
        {features.map((feature, idx) => (
          <li
            key={idx}
            className={`flex items-center gap-2 font-NotoSans text-TextColor-0 border-b border-dashed border-SecondaryColor-0 border-opacity-15 pb-2.5 ${
