          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-0 p-10 bg-white rounded-2xl shadow-shades relative z-20 -mt-[62px]">
            ...
            <div className="">
              <div>
                ...
                <p className="font-NotoSans text-TextColor-0 mt-5 max-w-[580px] w-full">
      ...
      <section className="py-16 md:py-20 lg:py-28 bg-white shadow rounded-lg">
        <div className="Container">
          ...
          >
            <div>
              <div className="flex items-start gap-3 mt-8">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-10 mb-1">
                    ...
                    <p className="font-NotoSans text-TextColor-0 relative before:absolute before:top-1/2 before:-translate-y-1/2 before:-left-[26px] before:w-3 before:h-[1px] before:bg-SecondaryColor-0">
                      Feb 29, 2025
                    </p>
                  </div>
              ...
              <div className="mt-16">
                ...
                <p className="font-NotoSans text-TextColor-0 mb-6">
          ...
          <div
            ...
            className="overflow-hidden transition-all duration-500 ease-in-out"
          >
            <div className="text-TextColor-0 font-NotoSans max-w-[930px] w-full">
              ...
              <p className="mt-6 font-NotoSans text-TextColor-0">
