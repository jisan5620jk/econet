...
const DonationCard = ({ image, category, title, raised, goal, color, URL }) => {
  ...
  return (
    <div className="group bg-BodyBg-0 rounded-xl sm:rounded-[30px] overflow-hidden w-full">
      ...
      <div className="px-6 sm:px-8 lg:px-6 xl:px-[42px] pt-7 sm:pt-9 pb-8 sm:pb-11">
        <Link
          to={URL}
