    ...
    <>
      ...
      <div className="Container lg:p-0">
        <div className="px-[50px] pt-[50px] -mt-14 bg-white border border-SecondaryColor-0 border-opacity-10 rounded-xl relative z-20">
          ...
          <article className="">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <div className="flex items-center font-NotoSans text-TextColor-0 gap-6">
            ...
            <p className="font-NotoSans text-TextColor-0 mt-4">
          ...
          <div className="px-10 py-11 rounded-md bg-BodyBg-0">
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1">
                ...
                <span className="text-TextColor-0 font-NotoSans mt-1 block">
                  May 5, 2025
                </span>
                <p className="font-NotoSans text-TextColor-0 mt-2 max-w-[990px] w-full">
        ...
        <section className="mt-16 pb-16 md:pb-20 lg:pb-28">
          ...
          <p className="font-NotoSans text-TextColor-0 mb-9">
            Your email address will not be published. So, don’t worry.
          </p>
          <form className="space-y-6">
            <textarea
              className="w-full px-7 py-4 rounded-md border border-HeadingColor-0 font-NotoSans border-opacity-10 transition-all duration-500 hover:border-PrimaryColor-0 focus:border-PrimaryColor-0 outline-none placeholder:text-TextColor-0"
              rows="5"
            ...
            <label className="flex items-center gap-2 font-NotoSans text-TextColor-0">
