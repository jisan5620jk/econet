          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-12">
            <div className="col-span-2">
              <div className="border border-BorderColor2-0 rounded-md overflow-hidden">
                <div className="relative">
                  <img
                    ...
                    className="w-full"
                  />
                  <h6 className="font-Outfit text-white px-5 py-2 rounded absolute top-5 left-5 bg-PrimaryColor-0">
                    Environment
                  </h6>
                </div>
                <div className="px-4 sm:px-8">
                  <Link to={"/blog_details"}>
                    <button className="font-Outfit font-bold text-left text-lg sm:text-2xl 2xl:text-3xl text-HeadingColor-0 transition-all duration-500 hover:text-PrimaryColor-0 mt-9 mb-6">
                      How Every Individual Can Make a Difference
                    </button>
                  </Link>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-5 mb-7">
                    <h6 className="flex items-center gap-2 font-Outfit text-TextColor-0 font-light">
                  ...
                  <p className="font-Outfit font-light text-TextColor-0 border-t border-BorderColor1-0 pt-5">
                  ...
                  <p className="font-Outfit font-light text-TextColor-0 mt-5">
                  ...
                  <Link to={"/blog_details"}>
                    <button className="font-Outfit font-semibold text-left text-2xl text-HeadingColor-0 transition-all duration-500 hover:text-PrimaryColor-0 mt-14 mb-4">
                      Clean Enviromnent Policy
                    </button>
                  </Link>
                  <p className="font-Outfit font-light text-TextColor-0">
                    Dramatically matrix cross-media vortals wireless
                    deliverables. Phosfluorescently underwhelm market driven
                    e-services and 24/365 infrastructures. Intrinsicly
                  ...
                  <ul className="flex flex-col gap-[14px] mt-7">
                    <li className="flex gap-3 items-center font-Outfit font-light text-TextColor-0">
                      <FaCircleCheck
                        size={"20"}
                  ...
                  <Link to={"/blog_details"}>
                    <button className="font-Outfit font-semibold text-left text-2xl text-HeadingColor-0 transition-all duration-500 hover:text-PrimaryColor-0 mt-10 mb-4">
                ...
                <div className="flex flex-col sm:flex-row gap-5 items-start sm:justify-between border-t border-BorderColor1-0 mt-9 py-5 px-4 sm:px-8">
                  <div>
                    <h6 className="font-Outfit text-lg font-medium">
                      <Link to={"/"}>
                        <button className="font-Outfit font-normal text-sm px-5 py-2 text-HeadingColor-0 rounded bg-[#f3f4f8] transition-all duration-500 hover:bg-PrimaryColor-0 hover:text-white mr-2 ml-1">
                          Environmental
                        </button>
                      </Link>
                      <Link to={"/"}>
                        <button className="font-Outfit font-normal text-sm px-5 py-2 text-HeadingColor-0 rounded bg-[#f3f4f8] transition-all duration-500 hover:bg-PrimaryColor-0 hover:text-white">
                          Cleaning
                        </button>
                      </Link>
                    </h6>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-[60px]">
                <div className="rounded-md bg-[#f3f4f8] pt-8 pb-10 px-9">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="font-Outfit font-medium sm:text-lg md:text-base 2xl:text-lg text-HoverColor-0 sm:leading-[26px]">
              ...
              <div className="bg-[#f3f4f8] px-4 sm:px-[62px] py-14 rounded-md mt-[60px]">
                <h3 className="font-Outfit font-semibold text-HeadingColor-0 text-2xl mb-10">
                  Comments 02
                </h3>
                <div className="flex flex-col sm:flex-row gap-6 border-b border-BorderColor1-0 pb-8">
                  ...
                  <div className="flex-1 relative">
                    ...
                    <p className="font-Outfit font-light text-TextColor-0 mt-3">
                ...
                <h3 className="font-Outfit font-semibold text-HeadingColor-0 text-xl sm:text-2xl mt-20 mb-10">
                  Post A Comments
                </h3>
                <form action="#" method="post">
                  <div className="grid sm:grid-cols-2 gap-4 sm:gap-7 mb-5">
                    <input
                      ...
                      required
                      className="outline-none rounded-md font-Outfit text-sm placeholder:text-TextColor-0 bg-white w-full px-6 py-2 h-[56px]"
                    />
                    <input
                      type="email"
                      name="email"
                  ...
                  <textarea
                    ...
                    required
                    className="outline-none resize-none rounded-md font-Outfit placeholder:text-TextColor-0 text-sm bg-white w-full px-6 py-3 h-[160px]"
                  ></textarea>
            ...
            <div className="col-span-2 lg:col-span-1">
              <div className="relative inline-block w-full mb-7 p-4 sm:p-8 lg:p-6 xl:p-8 rounded-md bg-[#f3f4f8]">
                <input
                  ...
                  required
                  className="w-full h-[56px] p-6 rounded font-Outfit"
                />
                <button
                  type="submit"
              ...
              <div className="bg-[#f3f4f8] rounded-md px-4 sm:px-8 lg:px-6 xl:px-8 pt-7 pb-4 mb-7">
                <h4 className="font-Outfit font-semibold text-2xl text-HeadingColor-0 pb-3 mb-8 relative before:absolute before:bottom-0 before:left-0 before:w-7 before:h-[2px] before:bg-PrimaryColor-0">
                  Categories
                </h4>
                <ul className="mt-8">
                  <li>
                    <Link to={"/service_details"}>
                      <button className="w-full font-Outfit text-left text-HeadingColor-0 transition-all duration-500 group px-7 py-4 flex items-center justify-between rounded bg-white mb-3 overflow-hidden z-[1] relative before:absolute before:top-0 before:right-0 before:w-0 before:-z-[1] before:h-full before:bg-PrimaryColor-0 before:rounded before:transition-all before:duration-500 hover:before:w-full hover:before:left-0 hover:text-white">
                ...
                <Link to={"/blog-details"}>
                  <button className="group flex gap-4 mb-6">
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <p className="font-Outfit text-PrimaryColor-0 text-sm mt-1">
                        01 Jan, 2024
                      </p>
                    </div>
                  </button>
              ...
              <div className="bg-[#f3f4f8] rounded-md px-4 sm:px-8 lg:px-6 xl:px-8 pt-7 pb-10 mb-7">
                ...
                <ul className="inline-block">
                  <li className="inline-block mr-[10px] mb-[10px]">
                    <Link to={"/"}>
                      <button className="bg-white rounded flex items-center justify-center text-HeadingColor-0 transition-all duration-500 font-medium px-5 py-2 font-Outfit text-sm relative z-[1] before:absolute before:top-0 before:left-0 before:rounded before:w-full before:h-full before:bg-PrimaryColor-0 before:transition-all before:duration-500 before:scale-0 before:-z-[1] hover:before:scale-100 hover:text-white">
                        Environment
                      </button>
                    </Link>
                  </li>
