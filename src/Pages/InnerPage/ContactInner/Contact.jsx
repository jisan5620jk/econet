        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
          <div>
            <div>
              ...
              <h1 className="font-Outfit font-semibold text-xl leading-7 sm:text-[34px] sm:leading-[44px] md:text-[44px] md:leading-[54px] lg:text-[30px] lg:leading-[40px] xl:text-[36px] xl:leading-[46px] 2xl:text-[42px] 2xl:leading-[52px] text-HeadingColor-0 mt-2 md:mt-[14px] mb-4">
                ...
                <br /> People with Econet
              </h1>
              <p className="font-NotoSans text-TextColor-0 pt-2">
            ...
            <div className="bg-BodyBg-0 rounded-xl p-10 mt-10">
              <div className="flex items-center gap-5 group border-b border-dashed border-HeadingColor-0 border-opacity-20 pb-5">
                ...
                <div>
                  <h6 className="font-NotoSans text-TextColor-0">
                    Call us Anytime
                  </h6>
              ...
              <div className="flex items-center gap-5 group border-b border-dashed border-HeadingColor-0 border-opacity-20 py-5">
                <div className="size-[70px] bg-white rounded-full flex items-center justify-center text-PrimaryColor-0 transition-all duration-500 group-hover:text-white relative z-10 before:absolute before:left-0 before:top-0 before:size-full before:bg-PrimaryColor-0 before:transition-all before:duration-500 before:scale-0 before:-z-10 before:rounded-full group-hover:before:scale-100">
                  <FaRegEnvelopeOpen size={"25"} />
                </div>
                <div>
                  <h6 className="font-NotoSans text-TextColor2-0">E-Mail us</h6>
                  <a
              ...
              <div className="flex items-center gap-5 group pt-5 pb-2">
                ...
                <div>
                  ...
                  <p className="font-NotoSans text-HeadingColor-0 mt-2">
          ...
          <div className="relative z-20 bg-white shadow-shades pt-16 px-4 sm:px-6 md:px-[50px] lg:px-4 xl:px-10 2xl:px-[50px] rounded-xl">
            ...
            <form
              action="#"
              method="post"
              className="flex flex-col gap-y-5 pt-10 pb-12"
            >
              ...
              <textarea
                ...
                className="font-Outfit text-HeadingColor-0 placeholder:text-TextColor-0 text-sm bg-transparent border border-Secondarycolor-0 border-opacity-15 rounded py-2 px-6 h-[120px] w-full focus:outline-PrimaryColor-0 resize-none"
              ></textarea>
              <label
                htmlFor="terms"
                className="font-NotoSans text-TextColor-0 text-sm flex items-center gap-2 cursor-pointer"
              >
