        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
          <div>
            <div>
              ...
              <p className="fade-up font-NotoSans text-TextColor-0 pt-2">
                Globally engage cross-media leadership skills before cross-media
                <br className="hidden md:block" /> develope standardized
                platforms without robust
              </p>
            </div>
            <div className="box-row bg-BodyBg-0 rounded-[20px] p-4 sm:p-10 mt-10">
          ...
          <div className="relative z-20 bg-white shadow-shades pt-16 px-4 sm:px-6 md:px-[50px] lg:px-4 xl:px-10 2xl:px-[50px] rounded-[20px]">
            ...
            >
              <div className="box grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="relative inline-block">
                  <input
                    ...
                    required
                    className="font-NotoSans text-HeadingColor-0 placeholder:text-TextColor-0 bg-transparent border border-Secondarycolor-0 border-opacity-15 rounded-lg py-2 px-6 h-[54px] w-full focus:outline-PrimaryColor-0"
                  />
                  <FaUser
                    size={"14"}
              ...
              <div className="box grid grid-cols-1 sm:grid-cols-2 gap-5">
                <select
                  name="select"
                  id="select"
                  className="font-NotoSans text-TextColor-0 placeholder:text-TextColor-0 bg-transparent border border-Secondarycolor-0 border-opacity-15 rounded-lg py-2 px-6 h-[54px] w-full focus:outline-PrimaryColor-0"
                >
              ...
              <textarea
                ...
                className="box font-NotoSans text-HeadingColor-0 placeholder:text-TextColor-0 bg-transparent border border-Secondarycolor-0 border-opacity-15 rounded-lg py-2 px-6 h-[120px] w-full focus:outline-PrimaryColor-0 resize-none"
              ></textarea>
              <label
                htmlFor="terms"
                className="box font-NotoSans text-TextColor-0 flex items-center gap-2 cursor-pointer"
              >
