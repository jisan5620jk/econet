      ...
      <div className="sm:px-3 pt-6 text-left">
        ...
        <div className="flex items-center gap-3 mb-5 mt-2">
          ...
          <div>
            ...
            <p className="font-NotoSans text-[15px] text-TextColor-0">
              Instructor
            </p>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <Link to="/course">
            <button className="absolute left-0 font-Outfit inline-flex items-center gap-2 uppercase text-sm justify-between px-7 py-[12px] bg-PrimaryColor-0 border z-10 overflow-hidden rounded-full text-white transition-all duration-500 -bottom-20 group-hover:-bottom-4 hover:bg-PrimaryColor-0">
              Enroll Now
