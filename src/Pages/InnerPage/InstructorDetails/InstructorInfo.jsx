      ...
      <div className="Container">
        <div className="grid grid-cols-1 md:grid-cols-2 md:items-center gap-7 p-8 rounded-2xl bg-white shadow-shades -mt-[62px] relative z-20">
          ...
          <div className="lg:pl-10 lg:border-l border-HeadingColor-0 border-opacity-10 inline-block">
            ...
            <p className="mb-10 font-NotoSans text-TextColor-0 max-w-[460px] w-full">
              Hello I’m Anjelina Watson destination for knowledge seekers and We
              are committed to transforming special education impact global
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  className="font-NotoSans text-[15px] text-HeadingColor-0"
                >
                  example@gmail.com
                </a>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="font-NotoSans text-[15px] text-HeadingColor-0">
                  102/B main road, California-USA
                </p>
              </div>
            </div>
          </div>
