...
const TeamCard = ({
  ...
  return (
    <div className="group">
      <div className="relative z-10 overflow-hidden before:absolute before:bottom-0 before:left-0 before:bg-BodyBg-0 before:w-full before:h-1/2 before:rounded-t-md before:-z-10">
        <img src={teamThumb} className="lg:w-full xl:w-[inherit] m-auto" />
      </div>
      <div className="bg-BodyBg-0 text-center pt-[26px] pb-10 rounded-b-md relative before:absolute before:bottom-0 before:left-1/2 before:w-0 before:h-[5px] before:bg-PrimaryColor-0 before:rounded-md before:transition-all before:duration-500 group-hover:before:w-full group-hover:before:left-0">
