        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          >
            ...
            <div className="absolute top-0 right-0 md:relative lg:absolute xl:relative">
              <button
                type="submit"
                className="font-NotoSans bg-PrimaryColor-0 text-white font-medium px-3 sm:px-[52px] xl:px-10 2xl:px-[52px] py-3 sm:py-[18px] rounded-full relative z-10 overflow-hidden before:absolute before:top-0 before:right-0 before:w-0 before:h-full before:bg-PrimaryColor-0 before:transition-all before:duration-500 before:-z-10 hover:before:w-full hover:before:left-0"
              >
