...
const Banner = () => {
  return (
    <section className="bg-SecondaryColor-0 px-2 sm:px-4 lg:px-8 py-2 sm:py-4 lg:py-8 rounded-b-xl sm:rounded-b-2xl md:rounded-b-[30px] flex items-center relative z-30 overflow-hidden">
      <div className="w-full grid grid-cols-1 xl:grid-cols-2 items-center gap-8">
        ...
        <div className="bg-gradient-to-tl from-BodyBg-0 from-30% via-BoxBg3-0 to-BoxBg3-0 px-2 sm:px-10 md:px-16 lg:px-20 xl:px-10 3xl:px-[100px] pt-32 sm:pt-44 md:pt-[222px] 2xl:pt-[252px] 3xl:pt-[222px] pb-6 md:pb-[102px] rounded-md sm:rounded-2xl md:rounded-[20px] relative overflow-hidden">
          ...
          <div className="flex flex-wrap xl:flex-nowrap gap-5 justify-between mt-20 md:mt-[136px] xl:mt-24 2xl:mt-[136px] pt-5 border-t border-SecondaryColor-0">
            <div>
