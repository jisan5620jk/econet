...
const Blog = () => {
  return (
    <section className="bg-[url('/images/project-bg.png')] bg-top bg-cover bg-no-repeat py-16 md:py-20 lg:py-28 bg-white overflow-hidden relative z-10">
      <div className="Container">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            <h5 className="font-NotoSans font-medium text-sm text-SecondaryColor-0 uppercase pl-4 relative z-10 before:absolute before:top-1/2 before:left-0 before:-translate-y-1/2 before:bg-PrimaryColor-0 before:rounded-full before:size-[9px]">
              latest news & blog
            </h5>
            ...
            <div className="group rounded-[20px] overflow-hidden flex flex-col md:flex-row">
              ...
              <div className="bg-white -mt-8 md:mt-0 md:-ml-[30px] rounded-[20px] pl-4 md:pl-10 lg:pl-5 xl:pl-10 pr-3 md:pr-8 lg:pr-4 xl:pr-8 pt-6 pb-6 md:pt-0 md:pb-0 flex items-center w-full relative z-10 overflow-hidden">
                ...
                <div>
                  ...
                  <p className="font-NotoSans text-TextColor-0 transition-all duration-500 group-hover:text-white">
