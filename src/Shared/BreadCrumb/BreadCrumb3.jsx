    ...
    <div className="bg-[url('/images/breadcrumb-bg2.png')] bg-no-repeat bg-cover bg-center flex items-center justify-start pt-[196px] pb-[100px] relative z-10">
      <div className="Container relative">
        ...
        <ul className="flex flex-col sm:flex-row gap-2 sm:gap-3 sm:items-center mt-6">
          ...
          <li>
            <Link to={url}>
              <button className="font-Outfit font-medium uppercase text-PrimaryColor-0 transition-all duration-500 hover:text-PrimaryColor-0">
                {breadCrumbLink}
              </button>
            </Link>
          </li>
        ...
        <div className="flex items-center flex-wrap gap-7 mt-14">
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="font-NotoSans text-TextColor-0 text-sm">
                Instructor
              </p>
            </div>
          </div>
          ...
          {/* Ratings */}
          <div className="flex flex-col justify-center">
            <p className="font-NotoSans text-TextColor-0 text-sm">3 Ratings</p>
