...
const Footer = () => {
  return (
    <>
              ...
              >
                <label htmlFor="email" className="relative">
                  <input
                    ...
                    required
                    className="w-full sm:w-[388px] h-[52px] font-NotoSans bg-transparent rounded-full outline-none focus:outline-none border border-white border-opacity-15 pl-14 pr-8 py-2 text-white placeholder:text-white placeholder:text-opacity-50"
                  />
                ...
                <div className="absolute top-0 right-0">
                  <button
                    type="submit"
                    className="size-[52px] flex items-center justify-center bg-PrimaryColor-0 rounded-full text-white relative z-10 overflow-hidden before:absolute before:left-0 before:top-0 before:-z-10 before:w-full before:h-full before:bg-PrimaryColor-0 before:scale-0 before:transition-all before:duration-500 before:rotate-180 hover:before:rotate-0 hover:before:scale-100"
                  >
      ...
      <footer className="bg-SecondaryColor-0 relative pt-28 overflow-hidden pb-[52px]">
        <div className="Container">
          <div className="grid gap-y-7 grid-cols-12 lg:mt-8">
            <div className="col-span-12 md:col-span-6 lg:col-span-4">
              ...
              <p className="font-NotoSans text-white text-opacity-60 mt-7 lg:mt-0 mb-5 w-full max-w-[272px]">
            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-3">
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="font-NotoSans text-sm text-PrimaryColor-0 mt-1">
                    Sep 26, 2025
                  </p>
                </div>
              </Link>
        ...
        <div className="mt-16 md:mt-[96px]">
          <div className="Container">
            <div className="flex flex-col md:flex-row gap-y-7 md: md:col-span-6 justify-between md:items-center py-5 border-t border-white border-opacity-15">
              <div>
                <p
                  className="font-NotoSans text-white text-opacity-60"
                  data-no-animate
                >
