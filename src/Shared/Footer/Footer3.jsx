...
const Footer = () => {
  return (
    <>
      <footer className="mx-2 sm:mx-3 md:mx-5 lg:mx-2 xl:mx-5 2xl:mx-8 3xl:mx-[50px] mb-2 sm:mb-3 md:mb-5 2xl:mb-8 3xl:mb-[50px] rounded-b-lg lg:rounded-b-2xl bg-HeadingColor-0 relative pt-16 md:pt-20 lg:pt-28 pb-[52px] overflow-hidden">
        ...
        <div className="bg-white bg-opacity-5 mt-16 md:mt-[96px]">
          <div className="Container">
            <div className="flex flex-col md:flex-row gap-y-7 md: md:col-span-6 justify-between md:items-center py-7">
              <div>
                <p className="font-NotoSans text-white" data-no-animate>
              ...
              <div>
                <ul className="flex items-center gap-5 sm:gap-10">
                  <li>
                    <Link
                      to={"/"}
                      className="font-NotoSans text-white"
                      data-no-animate
                    >
                      Terms & Conditions
                    </Link>
