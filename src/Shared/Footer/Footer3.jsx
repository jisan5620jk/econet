...
const Footer3 = () => {
  return (
    <div className="bg-[url('/images/footer-bg.png')] bg-cover bg-center bg-no-repeat -mt-12">
      ...
      <footer className="bg-BodyBgDark-0 pt-16 md:pt-20 lg:pt-[100px] border-t-[3px] sm:border-t-4 md:border-t-[10px] border-PrimaryColor-0 relative overflow-hidden">
        <div className="Container">
