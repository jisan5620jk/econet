    ...
    <div>
      ...
      <div className="bg-SecondaryColor-0 px-2 sm:px-3 md:px-5 lg:px-2 xl:px-5 2xl:px-8 3xl:px-[50px] flex justify-between items-center">
        <div className="sm:flex items-center gap-3 hidden">
          ...
          <p className="font-NotoSans text-[15px] text-white text-opacity-80">
            Welcome to{" "}
            <Link to={"#"} className="text-PrimaryColor-0 text-opacity-100">
              Educate
            </Link>{" "}
              ...
              <div className="flex items-center gap-2 sm:gap-7 lg:gap-5 xl:gap-[34px]">
                ...
                <div className="flex items-center gap-4">
                  <div className="hidden lg:block">
                    <Link
                      to={"/contact"}
                      className="inline-flex items-center gap-2 text-base uppercase text-white font-medium font-Outfit rounded-full bg-PrimaryColor-0 px-[30px] py-3 transition-all duration-500 relative z-10 overflow-hidden before:absolute before:h-full before:w-0 before:bg-PrimaryColor-0 before:opacity-50 before:top-0 before:left-auto before:right-0 before:transition-all before:duration-500 before:-z-10 hover:before:left-0 hover:before:opacity-100 hover:before:w-full hover:right-auto"
                    >
                      Free Trial
                  ...
                  <div
                    className="group hidden size-[46px] bg-PrimaryColor-0 rounded-full 2xl:flex items-center justify-center cursor-pointer"
        ...
        <div className="mt-8 mb-12">
          ...
          <ul className="space-y-4 text-white text-sm font-outfit">
            <li className="flex items-center">
              ...
              <Link to="/" className="ml-2 hover:text-[#1ec28f] transition">
      ...
      >
        ...
        <div className="flex justify-between items-center p-4 border-b">
          <h4 className="font-Outfit text-2xl sm:text-[28px] text-white font-medium">
            Your Cart
          </h4>
          <button
            ...
            cartItems.map((item) => (
              <div key={item.id} className="flex gap-4 relative border-b py-5">
                ...
                <div className="flex-1">
                  <h5 className="font-Outfit text-sm sm:text-base text-white">
                    {item.title}
                  </h5>
                ...
                <button
                  ...
                  className="absolute top-1/2 -translate-y-1/2 right-0 text-gray-400 transition-all duration-300 size-7 flex items-center justify-center bg-white shadow-xl border border-white border-opacity-10 rounded-full hover:text-red-500"
                >
                  <FaTimes size={12} />
                </button>
              </div>
        ...
        <div className="border-t p-4 flex flex-col gap-5">
          <div className="flex items-center justify-between font-Outfit text-2xl sm:text-[28px] text-white font-medium">
            <span>Total:</span>
            <span>${total}.00</span>
          </div>
          <Link to="/cart">
