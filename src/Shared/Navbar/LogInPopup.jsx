      ...
      >
        ...
        >
          <form className="bg-white flex flex-col items-center justify-center px-[50px] h-full text-center">
            <h1 className="font-medium text-2xl md:text-3xl font-Outfit">
              Create Account
            </h1>
            ...
            <span className="font-NotoSans mb-4">
        ...
        >
          <form className="bg-white flex flex-col items-center justify-center px-8 h-full text-center">
            ...
            <span className="mb-5 font-NotoSans">or use your account</span>
            <input
              type="email"
              placeholder="Email"
              className="bg-SecondaryColor-0 bg-opacity-5 rounded-md border-none py-3 px-5 my-2 w-full"
        ...
        >
          ...
          >
            ...
            >
              ...
              <p className="font-NotoSans leading-5 my-6">
            ...
            >
              ...
              <p className="leading-5 font-NotoSans my-6">
