                      ...
                      {item.links.length > 1 ? (
                        <>
                          <Link
                            ...
                            className={`clip-hover inline-flex items-center gap-1.5 2xl:mx-1 my-[35px] font-Outfit font-medium capitalize text-lg transition-all duration-500 hover:text-PrimaryColor-0 relative z-10 overflow-hidden
                                ${
                        ...
                        <Link
                          to={item.links[0].to}
                          className={`inline-flex items-center gap-1.5 mx-1 my-[35px] font-Outfit font-medium text-lg capitalize transition-all duration-500 hover:text-PrimaryColor-0 relative z-10 overflow-hidden ${
