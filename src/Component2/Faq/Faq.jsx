          ...
          <div className="relative z-10 lg:pb-20">
            ...
            <ul className="space-y-5 mt-8">
              {faqData.map((faq, index) => (
                <li key={index} className="rounded-lg bg-white">
                  <div className="">
                    <div
                    ...
                    >
                      <p className="font-NotoSans font-medium text-[15px] sm:text-base text-TextColor2-0 pt-6 px-5 sm:px-[30px] pb-8 mr-5">
