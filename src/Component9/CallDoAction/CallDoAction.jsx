  ...
  return (
    <div className="bg-BodyBg-0">
      <div className="Container">
        <div className="relative z-10 pl-20 pt-20 pb-20 w-full rounded-[30px] overflow-hidden before:absolute before:-z-10 before:top-0 before:left-0 before:w-full before:h-full before:bg-[linear-gradient(295.67deg,_rgba(255,_255,_255,_0)_40.34%,_#ffffff_58.81%)] inline-block">
          ...
          <p className="font-NotoSans text-TextColor-0 max-w-[500px] w-full">
          ...
          <div className="flex items-center">
            ...
            <div>
              <h6 className="font-NotoSans text-TextColor-0 text-[15px]">
                Call Us (Toll Free)
              </h6>
              <a
