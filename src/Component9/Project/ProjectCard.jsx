...
const ProjectCard = ({
  ...
  return (
    <div className="group relative pb-5">
      <div className="rounded-[20px] relative z-10 bg-white p-3 sm:p-[18px] border border-transparent transition-all duration-500 ease-linear group-hover:border-PrimaryColor-0">
