    ...
    <div className="group relative z-10">
      <div className="bg-BodyBg-0 grid grid-cols-12 items-center gap-7 lg:gap-0 px-5 lg:px-0 py-5 md:py-8 rounded-[20px] relative z-10 before:absolute before:left-[19%] before:top-1/2 before:-translate-y-1/2 before:w-[1px] before:h-[100px] before:bg-SecondaryColor-0 before:bg-opacity-10 after:absolute after:left-[57%] after:top-1/2 after:-translate-y-1/2 after:w-[1px] after:h-[100px] after:bg-SecondaryColor-0 after:bg-opacity-10 overflow-hidden">
        ...
        <div className="col-span-12 sm:col-span-6 lg:col-span-3 2xl:col-span-2 lg:ml-auto lg:mr-5">
          <Link to={eventUrl}>
            <button className="text-HeadingColor-0 font-Outfit inline-flex items-center gap-2 uppercase text-sm justify-between px-5 sm:px-7 py-2 sm:py-3 border border-HeadingColor-0 overflow-hidden rounded-full transition-all duration-500 relative z-10 before:absolute before:right-0 before:top-0 before:w-0 before:h-full before:transition-all before:duration-500 before:bg-PrimaryColor2-0 before:-z-10 group-hover:before:w-full group-hover:before:left-0 group-hover:text-white">
              {eventBtnText}
