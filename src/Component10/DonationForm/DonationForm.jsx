  ...
  return (
    <section className="bg-SecondaryColor-0 relative z-10 before:absolute before:bg-[url(/images/charity-donation-form-bg.png)] before:left-0 before:top-0 before:w-full before:h-[72%] before:bg-cover before:bg-no-repeat before:bg-center pt-24 md:pt-32 lg:pt-[140px] -mt-12 md:-mt-14 lg:-mt-10 3xl:-mt-7">
      <div className="Container relative z-10">
        ...
        <div className="bg-BodyBgDark-0 rounded-[30px] relative before:absolute before:-top-3 md:before:-top-5 before:left-1/2 before:-translate-x-1/2 before:h-full before:w-[calc(100%-20px)] md:before:w-[calc(100%-40px)] before:bg-PrimaryColor-0 before:rounded-[30px] before:-z-10 after:absolute after:-top-6 md:after:-top-10 after:left-1/2 after:-translate-x-1/2 after:h-full after:w-[calc(100%-40px)] md:after:w-[calc(100%-80px)] after:bg-white/20 after:rounded-[30px] after:-z-20">
