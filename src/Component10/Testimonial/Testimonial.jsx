...
const Testimonial = () => {
  ...
  return (
    <div className="bg-gradient-to-t to-SecondaryColor-0 to-50% from-BodyBgDark-0 from-50%">
      <section className="bg-[url(/images/charity-testi-bg.png)] bg-cover bg-no-repeat bg-center relative z-30 pt-20 md:pt-24 lg:pt-[160px] pb-36 md:pb-52 lg:pb-[310px] -mt-6 -mb-6">
        ...
        <div className="relative z-10 pt-9 md:pt-[58px] pb-6">
