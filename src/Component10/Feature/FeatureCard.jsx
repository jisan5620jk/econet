...
const FeatureCard = ({ featureTitle, featureIcon, featureUrl }) => {
  return (
    <div className="group flex items-center gap-4 sm:gap-7 max-w-[420px] w-full pl-5 sm:pl-[48px] pr-5 sm:pr-7 py-7 sm:py-14 bg-[url(/images/charity-feature-bg.png)] bg-cover bg-center bg-no-repeat rounded-2xl sm:rounded-none relative z-10 overflow-hidden">
