  ...
  return (
    <div className="group">
      ...
      <div className="pr-10 lg:pr-[74px] pt-8">
        ...
        <Link
          to={blogurl}
          className="font-Outfit text-white inline-block text-lg sm:text-xl md:text-[22px] xl:text-xl 2xl:text-2xl font-medium lg:leading-[32px] transition-all duration-500 hover:text-PrimaryColor-0"
        >
          {blogTitle}
        </Link>
