...
const CourseCard = ({
  ...
  return (
    <div className="group rounded-[20px] overflow-hidden flex flex-col md:flex-row">
      ...
      <div className="bg-BodyBg2-0 -mt-8 md:mt-0 md:-ml-[76px] rounded-[20px] pt-5 sm:pt-8 md:pt-0 px-4 sm:pl-10 sm:pr-8 flex items-center w-full relative z-10 overflow-hidden">
        ...
        <div>
          ...
          <div className="flex items-center text-PrimaryColor-0 transition-all duration-500 group-hover:text-white mb-3">
            ...
            <span className="font-NotoSans text-sm text-HeadingColor-0 transition-all duration-500 group-hover:text-white ml-2">
              ({ratingCount})
            </span>
          </div>

          <p className="font-NotoSans text-TextColor-0 transition-all duration-500 group-hover:text-white mb-3 sm:mb-6">
            {description}
          </p>
