      ...
      <div className="Container">
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-7 2xl:gap-0 items-end">
          <div>
            ...
            <div>
              <img src={faqThumb} draggable={false} alt="Faq Image" />
            </div>
          </div>
          <div className="max-w-[602px] w-full lg:ml-auto">
            <p className="font-NotoSans text-TextColor-0 text-[17px] w-full max-w-[575px] mt-7 lg:mt-0 mb-9">
              ...
              {faqs.map((faq, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className="font-NotoSans text-TextColor-0 text-[17px] px-3 sm:px-6 py-4 sm:py-7">
                        {faq.answer}
                      </div>
                    </div>
                  </div>
