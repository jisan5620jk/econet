        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-[92px] lg:gap-10 items-center">
          ...
          <div className="relative">
            ...
            <ul className="w-full max-w-[430px] grid gap-x-9 gap-y-6 grid-cols-1 sm:grid-cols-2">
              <li>
                <h5 className="font-Outfit font-medium text-SecondaryColor-0 uppercase pl-5 relative z-10 before:absolute before:top-1/2 before:left-0 before:-translate-y-1/2 before:bg-PrimaryColor-0 before:rounded-full before:size-[9px]">
                  Create Your Profile
                </h5>
              </li>
              <li>
